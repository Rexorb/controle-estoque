...
Excelente ideia fazer uma pausa para organizar o README.md. Um bom README é o cartão de visitas do projeto e a principal documentação.

Eu turbinei o README para incluir uma estrutura mais profissional, focar nas tecnologias que estamos utilizando (Spring Boot, Thymeleaf, PostgreSQL), e ajustar as rotas de Produtos para refletir exatamente o que implementamos (/produtos/salvar via POST é o mais comum para formulários, mas mantive o /produtos como você havia proposto, ajustando a descrição).

Aqui está o novo README.md alinhado com o seu projeto Grapium:
...
Método	Rota	Descrição	Status	Acesso
GET	/relatorios	Página de menu de relatórios.	A fazer	Autenticado
GET	/relatorios/estoque	Relatório de níveis de estoque e alertas.	A fazer	Autenticado
GET	/relatorios/movimentacoes	Histórico e filtros de movimentações.	A fazer	Autenticado
